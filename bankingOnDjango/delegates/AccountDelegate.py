...
class AccountDelegate:
    ...
    def unassignBank(self, account_id):
        err_msg = (
            "Failed to unassign element " + str(account_id) + " for Bank on Account"
        )
    ...
    def assignBranch(self, account_id, branch_id):
        ...
        err_msg = (
            "Failed to assign element " + str(branch_id) + " for Branch on Account"
        )
    ...
    def unassignBranch(self, account_id):
        err_msg = (
            "Failed to unassign element " + str(account_id) + " for Branch on Account"
        )
    ...
    def assignProduct(self, account_id, product_id):
        ...
        err_msg = (
            "Failed to assign element " + str(product_id) + " for Product on Account"
        )
    ...
    def unassignProduct(self, account_id):
        err_msg = (
            "Failed to unassign element " + str(account_id) + " for Product on Account"
        )
    ...
    def removeOwners(self, account_id, owners_ids):
        ...
        err_msg = (
            "Failed to remove elements " + str(owners_ids) + " for Owners on Account"
        )
        ...
        try:
            ...
            raise Exceptions.ProcessingError(
                "Customer with id " + str(owners_ids) + " does not exist."
            )
        except utils.Exceptions.DatabaseError:
    ...
    def removeTransactions(self, account_id, transactions_ids):
        ...
        try:
            ...
            raise Exceptions.ProcessingError(
                "Transaction with id " + str(transactions_ids) + " does not exist."
            )
        except utils.Exceptions.DatabaseError:
            raise Exceptions.StorageWriteError()
        except Exception:
    ...
    def addStatements(self, account_id, statements_ids):
        ...
        try:
            ...
            raise Exceptions.ProcessingError(
                err_msg + " : AccountStatement does not exist."
            )
        except Exception:
            raise Exceptions.ProcessingError(err_msg)
    ...
    def removeStatements(self, account_id, statements_ids):
        ...
        try:
            ...
            raise Exceptions.ProcessingError(
                "AccountStatement with id " + str(statements_ids) + " does not exist."
            )
        except utils.Exceptions.DatabaseError:
            raise Exceptions.StorageWriteError()
        except Exception:
    ...
    def addStandingInstructions(self, account_id, standing_instructions_ids):
        ...
        try:
            ...
            raise Exceptions.ProcessingError(
                err_msg + " : StandingInstruction does not exist."
            )
        except Exception:
            raise Exceptions.ProcessingError(err_msg)
