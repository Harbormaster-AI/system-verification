...
class ExchangeRateDelegate:
    ...
    def assignBank(self, exchange_rate_id, bank_id):
        ...
        err_msg = (
            "Failed to assign element " + str(bank_id) + " for Bank on ExchangeRate"
        )
    ...
    def unassignBank(self, exchange_rate_id):
        err_msg = (
            "Failed to unassign element " + str(bank_id) + " for Bank on ExchangeRate"
        )
    ...
    def removeFxTrades(self, exchange_rate_id, fx_trades_ids):
        ...
        try:
            ...
            raise Exceptions.ProcessingError(
                "FXTrade with id " + str(fx_trades_id) + " does not exist."
            )
        except utils.Exceptions.DatabaseError:
