...
class LoanAccountDelegate:
    ...
    def unassignBank(self, loan_account_id):
        err_msg = (
            "Failed to unassign element " + str(bankId) + " for Bank on LoanAccount"
        )
    ...
    def assignBranch(self, loan_account_id, branchId):
        ...
        err_msg = (
            "Failed to assign element " + str(branchId) + " for Branch on LoanAccount"
        )
    ...
    def unassignBranch(self, loan_account_id):
        err_msg = (
            "Failed to unassign element " + str(branchId) + " for Branch on LoanAccount"
        )
    ...
    def assignProduct(self, loan_account_id, productId):
        ...
        err_msg = (
            "Failed to assign element " + str(productId) + " for Product on LoanAccount"
        )
