...
class LoanAccountDelegate:
    ...
    def get(self, loan_account_id):
        ...
        try:
            ...
            raise Exceptions.ProcessingError(
                "LoanAccount with id " + str(loan_account_id) + " does not exist."
            )
    ...
    def delete(self, loan_account_id):
        err_msg = "Failed to delete LoanAccount from db using id " + str(
            loan_account_id
        )
    ...
    def assignBank(self, loan_account_id, bank_id):
        ...
        err_msg = (
            "Failed to assign element " + str(bank_id) + " for Bank on LoanAccount"
        )
    ...
    def unassignBank(self, loan_account_id):
        err_msg = (
            "Failed to unassign element " + str(bank_id) + " for Bank on LoanAccount"
        )
    ...
    def assignBranch(self, loan_account_id, branch_id):
        ...
        err_msg = (
            "Failed to assign element " + str(branch_id) + " for Branch on LoanAccount"
        )
    ...
    def removeBorrowers(self, loan_account_id, borrowers_ids):
        ...
        try:
            ...
            raise Exceptions.ProcessingError(
                "Customer with id " + str(borrowers_id) + " does not exist."
            )
        except utils.Exceptions.DatabaseError:
    ...
    def addRepaymentSchedule(self, loan_account_id, repayment_schedule_ids):
        ...
        err_msg = (
            "Failed to add elements "
            + str(repayment_schedule_ids)
            + " for RepaymentSchedule on LoanAccount"
        )
        ...
        try:
            ...
            raise Exceptions.ProcessingError(
                err_msg + " : RepaymentSchedule does not exist."
            )
        except Exception:
            raise Exceptions.ProcessingError(err_msg)
    ...
    def removePayments(self, loan_account_id, payments_ids):
        ...
        try:
            ...
            raise Exceptions.ProcessingError(
                "LoanPayment with id " + str(payments_id) + " does not exist."
            )
        except utils.Exceptions.DatabaseError:
            raise Exceptions.StorageWriteError()
        except Exception:
    ...
    def removeCollateral(self, loan_account_id, collateral_ids):
        ...
        try:
            ...
            raise Exceptions.ProcessingError(
                "Collateral with id " + str(collateral_id) + " does not exist."
            )
        except utils.Exceptions.DatabaseError:
            raise Exceptions.StorageWriteError()
        except Exception:
    ...
    def removeFeeCharges(self, loan_account_id, fee_charges_ids):
        ...
        try:
            ...
            raise Exceptions.ProcessingError(
                "FeeCharge with id " + str(fee_charges_id) + " does not exist."
            )
        except utils.Exceptions.DatabaseError:
            raise Exceptions.StorageWriteError()
        except Exception:
