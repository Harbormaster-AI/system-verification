...
class LoanAccountDelegate:
    ...
    def removeBorrowers(self, loan_account_id, borrowers_ids):
        ...
        try:
            ...
            raise Exceptions.ProcessingError(
                "Customer with id " + str(borrowers_ids) + " does not exist."
            )
        except utils.Exceptions.DatabaseError:
    ...
    def removePayments(self, loan_account_id, payments_ids):
        ...
        try:
            ...
            raise Exceptions.ProcessingError(
                "LoanPayment with id " + str(payments_ids) + " does not exist."
            )
        except utils.Exceptions.DatabaseError:
            raise Exceptions.StorageWriteError()
        except Exception:
    ...
    def removeCollateral(self, loan_account_id, collateral_ids):
        ...
        try:
            ...
            raise Exceptions.ProcessingError(
                "Collateral with id " + str(collateral_ids) + " does not exist."
            )
        except utils.Exceptions.DatabaseError:
            raise Exceptions.StorageWriteError()
        except Exception:
    ...
    def removeFeeCharges(self, loan_account_id, fee_charges_ids):
        ...
        try:
            ...
            raise Exceptions.ProcessingError(
                "FeeCharge with id " + str(fee_charges_ids) + " does not exist."
            )
        except utils.Exceptions.DatabaseError:
            raise Exceptions.StorageWriteError()
        except Exception:
