...
class FeeChargeDelegate:
    ...
    def get(self, fee_charge_id):
        try:
            ...
            raise ProcessingError(
                "FeeCharge with id " + str(fee_charge_id) + " does not exist."
            )
    ...
    def assignAccount(self, fee_charge_id, accountId):
        ...
        err_msg = (
            "Failed to assign element " + str(accountId) + " for Account on FeeCharge"
        )
    ...
    def unassignAccount(self, fee_charge_id):
        err_msg = (
            "Failed to unassign element " + str(accountId) + " for Account on FeeCharge"
        )
