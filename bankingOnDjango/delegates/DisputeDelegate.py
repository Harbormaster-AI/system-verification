...
class DisputeDelegate:
    ...
    def assignCustomer(self, dispute_id, customer_id):
        ...
        err_msg = (
            "Failed to assign element " + str(customer_id) + " for Customer on Dispute"
        )
    ...
    def unassignCustomer(self, dispute_id):
        err_msg = (
            "Failed to unassign element " + str(dispute_id) + " for Customer on Dispute"
        )
    ...
    def assignAccount(self, dispute_id, account_id):
        ...
        err_msg = (
            "Failed to assign element " + str(account_id) + " for Account on Dispute"
        )
    ...
    def unassignAccount(self, dispute_id):
        err_msg = (
            "Failed to unassign element " + str(dispute_id) + " for Account on Dispute"
        )
    ...
    def assignPaymentCard(self, dispute_id, payment_card_id):
        # lazy importing avoids circular dependencies
        ...
        try:
            ...
            dispute.payment_card = payment_card
