...
class PaymentCardDelegate:
    ...
    def get(self, payment_card_id):
        ...
        try:
            ...
            raise Exceptions.ProcessingError(
                "PaymentCard with id " + str(payment_card_id) + " does not exist."
            )
    ...
    def delete(self, payment_card_id):
        err_msg = "Failed to delete PaymentCard from db using id " + str(
            payment_card_id
        )
    ...
    def assignBank(self, payment_card_id, bank_id):
        ...
        err_msg = (
            "Failed to assign element " + str(bank_id) + " for Bank on PaymentCard"
        )
    ...
    def addTransactions(self, payment_card_id, transactions_ids):
        ...
        err_msg = (
            ...
            + " for Transactions on PaymentCard"
        )
