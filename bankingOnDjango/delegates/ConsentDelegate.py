...
class ConsentDelegate:
    ...
    def assignCustomer(self, consent_id, customerId):
        ...
        err_msg = (
            "Failed to assign element " + str(customerId) + " for Customer on Consent"
        )
    ...
    def unassignCustomer(self, consent_id):
        err_msg = (
            "Failed to unassign element " + str(customerId) + " for Customer on Consent"
        )
    ...
    def assignThirdPartyProvider(self, consent_id, thirdPartyProviderId):
        ...
        try:
            ...
            thirdPartyProvider = (
                ThirdPartyProviderDelegate().get(thirdPartyProviderId).first()
            )
