...
class AccountStatementDelegate:
    ...
    def get(self, account_statement_id):
        err_msg = "Failed to get AccountStatement from db using id " + str(
        ...
        try:
            ...
            raise Exceptions.ProcessingError(
                "AccountStatement with id "
                + str(account_statement_id)
                + " does not exist."
            )
    ...
    def delete(self, account_statement_id):
        err_msg = "Failed to delete AccountStatement from db using id " + str(
            account_statement_id
        )
    ...
    def getAll(self):
        try:
            ...
            raise Exceptions.StorageReadError(
                "Failed to get all AccountStatement from db"
            )
        except Exception:
            return None
    ...
    def assignAccount(self, account_statement_id, account_id):
        ...
        err_msg = (
            ...
            + str(account_id)
            + " for Account on AccountStatement"
        )
