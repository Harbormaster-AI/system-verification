...
class TransactionDelegate:
    ...
    def assignExternalCounterparty(self, transaction_id, externalCounterparty_id):
        ...
        try:
            ...
            externalAccount = (
                ExternalAccountDelegate().get(externalCounterparty_id).first()
            )
    ...
    def assignFxTrade(self, transaction_id, fxTrade_id):
        ...
        try:
            ...
            raise Exceptions.ProcessingError(
                err_msg + " : FXTrade with id " + str(fxTrade_id) + " does not exist."
            )
        except Exception:
            return None
