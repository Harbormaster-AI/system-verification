...
class TransactionDelegate:
    ...
    def assignAccount(self, transaction_id, accountId):
        ...
        err_msg = (
            "Failed to assign element " + str(accountId) + " for Account on Transaction"
        )
    ...
    def assignExternalCounterparty(self, transaction_id, externalCounterpartyId):
        ...
        try:
            ...
            externalAccount = (
                ExternalAccountDelegate().get(externalCounterpartyId).first()
            )
    ...
    def assignFxTrade(self, transaction_id, fxTradeId):
        ...
        err_msg = (
            "Failed to assign element " + str(fxTradeId) + " for FxTrade on Transaction"
        )
        ...
        try:
            ...
            raise ProcessingError(
                err_msg + " : FXTrade with id " + str(fxTradeId) + " does not exist."
            )
        except Exception:
            return None
    ...
    def assignDispute(self, transaction_id, disputeId):
        ...
        err_msg = (
            "Failed to assign element " + str(disputeId) + " for Dispute on Transaction"
        )
        ...
        try:
            ...
            raise ProcessingError(
                err_msg + " : Dispute with id " + str(disputeId) + " does not exist."
            )
        except Exception:
            return None
