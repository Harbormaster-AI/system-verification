...
class CustomerDelegate:
    ...
    def addAccounts(self, customer_id, accountsIds):
        ...
        err_msg = (
            "Failed to add elements " + str(accountsIds) + " for Accounts on Customer"
        )
    ...
    def addDisputes(self, customer_id, disputesIds):
        ...
        err_msg = (
            "Failed to add elements " + str(disputesIds) + " for Disputes on Customer"
        )
    ...
    def addConsents(self, customer_id, consentsIds):
        ...
        err_msg = (
            "Failed to add elements " + str(consentsIds) + " for Consents on Customer"
        )
