...
class BankDelegate:
    ...
    def removeBranches(self, bank_id, branches_ids):
        ...
        try:
            ...
            raise Exceptions.ProcessingError(
                "Branch with id " + str(branches_ids) + " does not exist."
            )
        except utils.Exceptions.DatabaseError:
    ...
    def removeProducts(self, bank_id, products_ids):
        ...
        try:
            ...
            raise Exceptions.ProcessingError(
                "BankingProduct with id " + str(products_ids) + " does not exist."
            )
        except utils.Exceptions.DatabaseError:
            raise Exceptions.StorageWriteError()
        except Exception:
    ...
    def removeCustomers(self, bank_id, customers_ids):
        ...
        try:
            ...
            raise Exceptions.ProcessingError(
                "Customer with id " + str(customers_ids) + " does not exist."
            )
        except utils.Exceptions.DatabaseError:
            raise Exceptions.StorageWriteError()
        except Exception:
    ...
    def removePaymentCards(self, bank_id, payment_cards_ids):
        ...
        try:
            ...
            raise Exceptions.ProcessingError(
                "PaymentCard with id " + str(payment_cards_ids) + " does not exist."
            )
        except utils.Exceptions.DatabaseError:
            raise Exceptions.StorageWriteError()
        except Exception:
    ...
    def removeExchangeRates(self, bank_id, exchange_rates_ids):
        ...
        try:
            ...
            raise Exceptions.ProcessingError(
                "ExchangeRate with id " + str(exchange_rates_ids) + " does not exist."
            )
        except utils.Exceptions.DatabaseError:
            raise Exceptions.StorageWriteError()
        except Exception:
    ...
    def removeConsents(self, bank_id, consents_ids):
        ...
        try:
            ...
            raise Exceptions.ProcessingError(
                "Consent with id " + str(consents_ids) + " does not exist."
            )
        except utils.Exceptions.DatabaseError:
            raise Exceptions.StorageWriteError()
        except Exception:
