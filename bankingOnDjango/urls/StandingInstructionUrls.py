...
urlpatterns = [
    ...
    path('unassignAccount', StandingInstructionView.unassignAccount, name='unassignAccount'),



    path('assignBeneficiary', StandingInstructionView.assignBeneficiary, name='assignBeneficiary'),
    path('unassignBeneficiary', StandingInstructionView.unassignBeneficiary, name='unassignBeneficiary'),
