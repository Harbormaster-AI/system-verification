...
urlpatterns = [
    ...
    path(
        ...
        CustomerView.removeLoanAccounts,
        name="removeLoanAccounts",
    ),
    path("addToPaymentCards", CustomerView.addPaymentCards, name="addPaymentCards"),
    path(
        "removeFromPaymentCards",
        CustomerView.removePaymentCards,
        name="removePaymentCards",
    ),
    path(
        "addToExternalAccounts",
        CustomerView.addExternalAccounts,
        name="addExternalAccounts",
    ),
    path(
        "removeFromExternalAccounts",
        CustomerView.removeExternalAccounts,
        name="removeExternalAccounts",
    ),
    path(
        "addToFundsTransfers", CustomerView.addFundsTransfers, name="addFundsTransfers"
    ),
    path(
        "removeFromFundsTransfers",
        CustomerView.removeFundsTransfers,
        name="removeFundsTransfers",
    ),
    ...
    path(
        ...
        CustomerView.removeKycProfiles,
        name="removeKycProfiles",
    ),
