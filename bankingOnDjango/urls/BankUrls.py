...
urlpatterns = [
    ...
    path(
        "removeFromPaymentCards", BankView.removePaymentCards, name="removePaymentCards"
    ),
    path("addToLoanAccounts", BankView.addLoanAccounts, name="addLoanAccounts"),
    path(
        "removeFromLoanAccounts", BankView.removeLoanAccounts, name="removeLoanAccounts"
    ),
    path("addToExchangeRates", BankView.addExchangeRates, name="addExchangeRates"),
    path(
        "removeFromExchangeRates",
        BankView.removeExchangeRates,
        name="removeExchangeRates",
    ),
    ...
    path(
        ...
        BankView.addThirdPartyProviders,
        name="addThirdPartyProviders",
    ),
    path(
        "removeFromThirdPartyProviders",
        BankView.removeThirdPartyProviders,
        name="removeThirdPartyProviders",
    ),
]
