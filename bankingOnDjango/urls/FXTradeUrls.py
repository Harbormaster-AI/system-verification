...
urlpatterns = [
    ...
    path(
        "assignExchangeRate", FXTradeView.assignExchangeRate, name="assignExchangeRate"
    ),
    path(
        "unassignExchangeRate",
        FXTradeView.unassignExchangeRate,
        name="unassignExchangeRate",
    ),
    path(
        "assignSourceAccount",
        FXTradeView.assignSourceAccount,
        name="assignSourceAccount",
    ),
    path(
        "unassignSourceAccount",
        FXTradeView.unassignSourceAccount,
        name="unassignSourceAccount",
    ),
    path(
        "assignDestinationAccount",
        FXTradeView.assignDestinationAccount,
        name="assignDestinationAccount",
    ),
    path(
        "unassignDestinationAccount",
        FXTradeView.unassignDestinationAccount,
        name="unassignDestinationAccount",
    ),
    path("assignTransaction", FXTradeView.assignTransaction, name="assignTransaction"),
    path(
        "unassignTransaction",
        FXTradeView.unassignTransaction,
        name="unassignTransaction",
    ),
]
