...
urlpatterns = [
    ...
    path(
        "removeFromBorrowers", LoanAccountView.removeBorrowers, name="removeBorrowers"
    ),
    path(
        "addToRepaymentSchedule",
        LoanAccountView.addRepaymentSchedule,
        name="addRepaymentSchedule",
    ),
    path(
        "removeFromRepaymentSchedule",
        LoanAccountView.removeRepaymentSchedule,
        name="removeRepaymentSchedule",
    ),
