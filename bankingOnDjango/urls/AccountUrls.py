...
urlpatterns = [
    ...
    path(
        ...
        AccountView.removeTransactions,
    ...
    path(
        ...
        AccountView.addStandingInstructions,
        name="addStandingInstructions",
    ),
    path(
        "removeFromStandingInstructions",
        AccountView.removeStandingInstructions,
        name="removeStandingInstructions",
    ),
