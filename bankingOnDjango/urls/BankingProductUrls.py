...
urlpatterns = [
    ...
    path(
        "removeFromAccounts", BankingProductView.removeAccounts, name="removeAccounts"
    ),
    path(
        "addToLoanAccounts", BankingProductView.addLoanAccounts, name="addLoanAccounts"
    ),
    path(
        "removeFromLoanAccounts",
        BankingProductView.removeLoanAccounts,
        name="removeLoanAccounts",
    ),
    path(
        "addToPaymentCards", BankingProductView.addPaymentCards, name="addPaymentCards"
    ),
    path(
        "removeFromPaymentCards",
        BankingProductView.removePaymentCards,
