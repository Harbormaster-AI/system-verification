...
urlpatterns = [
    ...
    path('assignLoanAccount', CollateralView.assignLoanAccount, name='assignLoanAccount'),
    path('unassignLoanAccount', CollateralView.unassignLoanAccount, name='unassignLoanAccount'),
