...
urlpatterns = [
    ...
    path(
        "assignLoanAccount",
        RepaymentScheduleView.assignLoanAccount,
        name="assignLoanAccount",
    ),
    path(
        "unassignLoanAccount",
        RepaymentScheduleView.unassignLoanAccount,
        name="unassignLoanAccount",
    ),
    path("assignPayment", RepaymentScheduleView.assignPayment, name="assignPayment"),
    path(
        "unassignPayment", RepaymentScheduleView.unassignPayment, name="unassignPayment"
    ),
]
