...
urlpatterns = [
    ...
    path(
        "assignExternalCounterparty",
        TransactionView.assignExternalCounterparty,
        name="assignExternalCounterparty",
    ),
    path(
        "unassignExternalCounterparty",
        TransactionView.unassignExternalCounterparty,
        name="unassignExternalCounterparty",
    ),
    path(
        "assignPaymentCard", TransactionView.assignPaymentCard, name="assignPaymentCard"
    ),
    path(
        "unassignPaymentCard",
        TransactionView.unassignPaymentCard,
        name="unassignPaymentCard",
    ),
    path(
        "assignFundsTransfer",
        TransactionView.assignFundsTransfer,
        name="assignFundsTransfer",
    ),
    path(
        "unassignFundsTransfer",
        TransactionView.unassignFundsTransfer,
        name="unassignFundsTransfer",
    ),
