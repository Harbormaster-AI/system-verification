...
urlpatterns = [
    ...
    path('assignLoanAccount', FeeChargeView.assignLoanAccount, name='assignLoanAccount'),
    path('unassignLoanAccount', FeeChargeView.unassignLoanAccount, name='unassignLoanAccount'),
