...
urlpatterns = [
    ...
    path(
        ...
        KycProfileView.addIdentityDocuments,
        name="addIdentityDocuments",
    ),
    path(
        "removeFromIdentityDocuments",
        KycProfileView.removeIdentityDocuments,
        name="removeIdentityDocuments",
    ),
    path(
        "addToRiskAssessments",
        KycProfileView.addRiskAssessments,
        name="addRiskAssessments",
    ),
    path(
        "removeFromRiskAssessments",
        KycProfileView.removeRiskAssessments,
        name="removeRiskAssessments",
    ),
    path("addToScreenings", KycProfileView.addScreenings, name="addScreenings"),
    path(
        "removeFromScreenings", KycProfileView.removeScreenings, name="removeScreenings"
    ),
]
