...
urlpatterns = [
    ...
    path(
        "assignLoanAccount", LoanPaymentView.assignLoanAccount, name="assignLoanAccount"
    ),
    path(
        "unassignLoanAccount",
        LoanPaymentView.unassignLoanAccount,
        name="unassignLoanAccount",
    ),
    path(
        "assignTransaction", LoanPaymentView.assignTransaction, name="assignTransaction"
    ),
    path(
        "unassignTransaction",
        LoanPaymentView.unassignTransaction,
