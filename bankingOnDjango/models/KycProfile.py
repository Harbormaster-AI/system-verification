...
#======================================================================
	profile_id = models.CharField(max_length=200, null=True)
	last_reviewed_on = models.DateField(null=True)
	customer = models.ForeignKey('Customer', on_delete=models.CASCADE, null=True, blank=True, related_name='+')
	identity_documents = models.ManyToManyField('IdentityDocument',  blank=True, related_name='+')
	risk_assessments = models.ManyToManyField('RiskAssessment',  blank=True, related_name='+')
