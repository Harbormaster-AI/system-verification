...
#======================================================================
	...
	standing_instructions = models.ManyToManyField('StandingInstruction',  blank=True, related_name='+')
	fee_charges = models.ManyToManyField('FeeCharge',  blank=True, related_name='+')
	account_type = models.CharField(max_length=64, null=True, choices=[(tag.name, tag.value) for tag in AccountType])
	ownership_type = models.CharField(max_length=64, null=True, choices=[(tag.name, tag.value) for tag in AccountOwnershipType])
