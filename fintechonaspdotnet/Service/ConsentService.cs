...
public interface IConsentService
{
    ...
    Task<bool> AssignApiClient(AssociationRequest request, CancellationToken cancellationToken);
    Task<bool> UnassignApiClient(AssociationRequest request, CancellationToken cancellationToken);
...
public class ConsentService : IConsentService
{
    ...
    public async Task<bool> Update(Consent model, CancellationToken cancellationToken)
    {
        try
        {
            ...
            existing.GrantedAt = model.GrantedAt;
