class PaymentCard < ApplicationRecord
  enum CARD_TYPE: %i[Debit Credit Prepaid Virtual]
  enum CARD_STATUS: %i[Active Blocked LostStolen Expired Closed]
  enum NETWORK: %i[Visa Mastercard Amex Discover UnionPay Other]
