class LoanAccount < ApplicationRecord
  enum LOAN_TYPE: %i[Mortgage Personal Auto SmallBusiness CreditLine Student]
  enum RATE_TYPE: %i[Fixed Variable]
  enum COMPOUNDING: %i[Daily Monthly Quarterly Annually]
  enum STATUS: %i[Applied Approved Active Delinquent Defaulted Closed]
