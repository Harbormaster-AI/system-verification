...
public class NoteService : INoteService
{
    ...
    public async Task Create(Note model, CancellationToken cancellationToken)
    {
        try
        {
    ...
    public Task<Note?> Get(IdentifierRequest identifier, CancellationToken cancellationToken)
    => _repository.GetByIdAsync(identifier.Id, cancellationToken);

    public Task<IReadOnlyList<Note>> GetAll(CancellationToken cancellationToken)
    ...
    public async Task<bool> AssignOrganization(AssociationRequest request, CancellationToken cancellationToken) {
        ...
        if (parent is null)
        {
            _logger.LogError("No Note found using Id {ParentId}", request.ParentId);
            return false;
        }
