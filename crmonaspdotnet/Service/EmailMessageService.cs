...
public interface IEmailMessageService {
    ...
    Task Create(EmailMessage model , CancellationToken cancellationToken);
    Task<bool> Update(EmailMessage model, CancellationToken cancellationToken);
    Task<EmailMessage?> Get(IdentifierRequest identifier, CancellationToken cancellationToken);
    Task<IReadOnlyList<EmailMessage>> GetAll(CancellationToken cancellationToken);
    ...
    Task<bool> AssignLead(AssociationRequest request, CancellationToken cancellationToken);
    Task<bool> UnassignLead(AssociationRequest request, CancellationToken cancellationToken);
    Task<bool> AssignCase_(AssociationRequest request, CancellationToken cancellationToken);
    Task<bool> UnassignCase_(AssociationRequest request, CancellationToken cancellationToken);
...
public class EmailMessageService : IEmailMessageService
{
    ...
    public async Task Create(EmailMessage model, CancellationToken cancellationToken)
    {
        try
        {
    ...
    public async Task<bool> Update(EmailMessage model, CancellationToken cancellationToken)
    {
        try {
            ...
            existing.SentAt = model.SentAt;
            existing.MessageId = model.MessageId;
    ...
    public Task<EmailMessage?> Get(IdentifierRequest identifier, CancellationToken cancellationToken)
    => _repository.GetByIdAsync(identifier.Id, cancellationToken);

    public Task<IReadOnlyList<EmailMessage>> GetAll(CancellationToken cancellationToken)
    ...
    public async Task<bool> AssignOrganization(AssociationRequest request, CancellationToken cancellationToken) {
        ...
        if (parent is null)
        {
            _logger.LogError("No EmailMessage found using Id {ParentId}", request.ParentId);
            return false;
        }
