...
$generateAppStats.applyMetaDataTag("Router Pattern", "Directs incoming requests or messages to the appropriate handler, service, or endpoint.", 5)
...
$generateAppStats.applyMetaDataTag("Router Pattern", "Directs incoming requests or messages to the appropriate handler, service, or endpoint.", 2)
