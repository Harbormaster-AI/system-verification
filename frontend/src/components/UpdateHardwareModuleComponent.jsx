...
class UpdateHardwareModuleComponent extends Component {
    constructor(props) {
        super(props)
        ...
        this.updateHardwareModule = this.updateHardwareModule.bind(this);
                   ...
                   <div className = "container">
                        <div className = "row">
                            <div className = "card col-md-6 offset-md-3 offset-md-3">
                                <h3 className="text-center">Update HardwareModule</h3>
                      ...
                      <option name="ModuleType" className="form-control" >
                          Other
                                        ...
                                        <button className="btn btn-success" onClick={this.updateHardwareModule}>Save</button>
...
export default UpdateHardwareModuleComponent
