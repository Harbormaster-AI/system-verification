...
class UpdateLoanAccountComponent extends Component {
    constructor(props) {
        super(props)
        ...
        this.updateLoanAccount = this.updateLoanAccount.bind(this);
                   ...
                   <div className = "container">
                        <div className = "row">
                            <div className = "card col-md-6 offset-md-3 offset-md-3">
                                <h3 className="text-center">Update LoanAccount</h3>
                                <div className = "card-body">
                                    <form>
                                        <div className = "form-group">
                                            ...
                                            <label> outstandingPrincipal: </label>
                      ...
                      <option name="Status" className="form-control" >
                          Closed
                                        ...
                                        <button className="btn btn-success" onClick={this.updateLoanAccount}>Save</button>
...
export default UpdateLoanAccountComponent
