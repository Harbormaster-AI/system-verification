...
export class BaseComponent {
  ...
  StandingInstructionFrequencys = Object.keys(
    enumTypes.StandingInstructionFrequency,
  );
  ...
  initIdentityDocumentList() {
    if (this.identityDocuments == null) {
      new IdentityDocumentService(this.http)
  ...
  initRiskAssessmentList() {
    if (this.riskAssessments == null) {
      new RiskAssessmentService(this.http)
        .getRiskAssessments()
        .subscribe((res) => {
  ...
  initScreeningResultList() {
    if (this.screeningResults == null) {
      new ScreeningResultService(this.http)
        .getScreeningResults()
        .subscribe((res) => {
  ...
  initBankingProductList() {
    if (this.bankingProducts == null) {
      new BankingProductService(this.http)
        .getBankingProducts()
        .subscribe((res) => {
  ...
  initAccountStatementList() {
    if (this.accountStatements == null) {
      new AccountStatementService(this.http)
  ...
  initExternalAccountList() {
    if (this.externalAccounts == null) {
      new ExternalAccountService(this.http)
        .getExternalAccounts()
        .subscribe((res) => {
  ...
  initFundsTransferList() {
    if (this.fundsTransfers == null) {
      new FundsTransferService(this.http)
        .getFundsTransfers()
        .subscribe((res) => {
  ...
  initStandingInstructionList() {
    if (this.standingInstructions == null) {
      new StandingInstructionService(this.http)
  ...
  initRepaymentScheduleList() {
    if (this.repaymentSchedules == null) {
      new RepaymentScheduleService(this.http)
  ...
  initThirdPartyProviderList() {
    if (this.thirdPartyProviders == null) {
      new ThirdPartyProviderService(this.http)
