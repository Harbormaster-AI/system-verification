...
export const BankRoutes: Routes = [
  ...
  { path: "indexBank", component: IndexBankComponent },
];
export const BranchRoutes: Routes = [
  ...
  { path: "indexBranch", component: IndexBranchComponent },
];
export const ATMRoutes: Routes = [
  ...
  { path: "indexATM", component: IndexATMComponent },
];
...
export const KycProfileRoutes: Routes = [
  { path: "createKycProfile", component: CreateKycProfileComponent },
  {
    path: "editKycProfile/:id",
    component: EditKycProfileComponent,
  },
  { path: "indexKycProfile", component: IndexKycProfileComponent },
];
export const IdentityDocumentRoutes: Routes = [
  {
  ...
  { path: "indexIdentityDocument", component: IndexIdentityDocumentComponent },
];
export const RiskAssessmentRoutes: Routes = [
  { path: "createRiskAssessment", component: CreateRiskAssessmentComponent },
  {
    path: "editRiskAssessment/:id",
    component: EditRiskAssessmentComponent,
  },
  { path: "indexRiskAssessment", component: IndexRiskAssessmentComponent },
];
export const ScreeningResultRoutes: Routes = [
  { path: "createScreeningResult", component: CreateScreeningResultComponent },
  {
    path: "editScreeningResult/:id",
    component: EditScreeningResultComponent,
  },
  { path: "indexScreeningResult", component: IndexScreeningResultComponent },
];
export const BankingProductRoutes: Routes = [
  { path: "createBankingProduct", component: CreateBankingProductComponent },
  {
    path: "editBankingProduct/:id",
    component: EditBankingProductComponent,
  },
  { path: "indexBankingProduct", component: IndexBankingProductComponent },
];
export const AccountRoutes: Routes = [
  ...
  { path: "indexAccount", component: IndexAccountComponent },
];
export const AccountStatementRoutes: Routes = [
  ...
  { path: "indexAccountStatement", component: IndexAccountStatementComponent },
];
export const TransactionRoutes: Routes = [
  ...
  { path: "indexTransaction", component: IndexTransactionComponent },
];
export const ExternalAccountRoutes: Routes = [
  { path: "createExternalAccount", component: CreateExternalAccountComponent },
  {
    path: "editExternalAccount/:id",
    component: EditExternalAccountComponent,
  },
  { path: "indexExternalAccount", component: IndexExternalAccountComponent },
];
export const FundsTransferRoutes: Routes = [
  { path: "createFundsTransfer", component: CreateFundsTransferComponent },
  {
    path: "editFundsTransfer/:id",
    component: EditFundsTransferComponent,
  },
  { path: "indexFundsTransfer", component: IndexFundsTransferComponent },
];
...
export const PaymentCardRoutes: Routes = [
  { path: "createPaymentCard", component: CreatePaymentCardComponent },
  {
    path: "editPaymentCard/:id",
    component: EditPaymentCardComponent,
  },
  { path: "indexPaymentCard", component: IndexPaymentCardComponent },
];
export const LoanAccountRoutes: Routes = [
  { path: "createLoanAccount", component: CreateLoanAccountComponent },
  {
    path: "editLoanAccount/:id",
    component: EditLoanAccountComponent,
  },
  { path: "indexLoanAccount", component: IndexLoanAccountComponent },
];
...
export const LoanPaymentRoutes: Routes = [
  { path: "createLoanPayment", component: CreateLoanPaymentComponent },
  {
    path: "editLoanPayment/:id",
    component: EditLoanPaymentComponent,
  },
  { path: "indexLoanPayment", component: IndexLoanPaymentComponent },
];
export const CollateralRoutes: Routes = [
  { path: "createCollateral", component: CreateCollateralComponent },
  {
    path: "editCollateral/:id",
    component: EditCollateralComponent,
  },
  { path: "indexCollateral", component: IndexCollateralComponent },
];
export const FeeChargeRoutes: Routes = [
  { path: "createFeeCharge", component: CreateFeeChargeComponent },
  {
    path: "editFeeCharge/:id",
    component: EditFeeChargeComponent,
  },
  { path: "indexFeeCharge", component: IndexFeeChargeComponent },
];
export const ExchangeRateRoutes: Routes = [
  { path: "createExchangeRate", component: CreateExchangeRateComponent },
  {
    path: "editExchangeRate/:id",
    component: EditExchangeRateComponent,
  },
  { path: "indexExchangeRate", component: IndexExchangeRateComponent },
];
export const FXTradeRoutes: Routes = [
  { path: "createFXTrade", component: CreateFXTradeComponent },
  {
    path: "editFXTrade/:id",
    component: EditFXTradeComponent,
  },
  { path: "indexFXTrade", component: IndexFXTradeComponent },
];
export const DisputeRoutes: Routes = [
  { path: "createDispute", component: CreateDisputeComponent },
  {
    path: "editDispute/:id",
    component: EditDisputeComponent,
  },
  { path: "indexDispute", component: IndexDisputeComponent },
];
export const ConsentRoutes: Routes = [
  { path: "createConsent", component: CreateConsentComponent },
  {
    path: "editConsent/:id",
    component: EditConsentComponent,
  },
  { path: "indexConsent", component: IndexConsentComponent },
];
export const ThirdPartyProviderRoutes: Routes = [
  {
