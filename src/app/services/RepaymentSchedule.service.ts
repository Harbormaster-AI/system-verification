...
export class RepaymentScheduleService extends HelperBaseService {
  ...
  addRepaymentSchedule(
    ...
    const obj = {
      ...
      totalDue: totalDue,
      LoanAccount:
        LoanAccount != null && LoanAccount.length > 0 ? LoanAccount : null,
  ...
  saveHelper(): Observable<any> {
    const uri_ =
      this.apiUrl + "/RepaymentSchedule/update/" + this.repaymentSchedule;
  ...
  //********************************************************************
  loadHelper(id) {
    this.getRepaymentSchedule(id).subscribe((res: RepaymentSchedule) => {
