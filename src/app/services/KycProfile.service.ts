...
export class KycProfileService extends HelperBaseService {
  ...
  addKycProfile(
    ...
    const obj = {
      ...
      IdentityDocuments:
        IdentityDocuments != null && IdentityDocuments.length > 0
          ? IdentityDocuments
          : null,
      RiskAssessments:
        RiskAssessments != null && RiskAssessments.length > 0
          ? RiskAssessments
          : null,
      Screenings:
        Screenings != null && Screenings.length > 0 ? Screenings : null,
      Status: Status,
    };
  ...
  addIdentityDocuments(kycProfileId, identityDocumentsIds): Observable<any> {
    ...
    idList.forEach(function (id) {
      ...
      var identityDocument = new IdentityDocumentService(
        this.http,
  ...
  addRiskAssessments(kycProfileId, riskAssessmentsIds): Observable<any> {
    ...
    idList.forEach(function (id) {
      ...
      var riskAssessment = new RiskAssessmentService(
        this.http,
  ...
  addScreenings(kycProfileId, screeningsIds): Observable<any> {
    ...
    idList.forEach(function (id) {
      ...
      var screeningResult = new ScreeningResultService(
        this.http,
  ...
  //********************************************************************
  loadHelper(id) {
    this.getKycProfile(id).subscribe((res: KycProfile) => {
      this.kycProfile = res;
    });
  }
}
