...
export class StandingInstructionService extends HelperBaseService {
  ...
  addStandingInstruction(
    ...
    const obj = {
      ...
      Beneficiary:
        Beneficiary != null && Beneficiary.length > 0 ? Beneficiary : null,
      Frequency: Frequency,
      Status: Status,
    };
  ...
  saveHelper(): Observable<any> {
    const uri_ =
      this.apiUrl + "/StandingInstruction/update/" + this.standingInstruction;
  ...
  //********************************************************************
  loadHelper(id) {
    this.getStandingInstruction(id).subscribe((res: StandingInstruction) => {
