 ...
 */
@Service
public class StandingInstructionService extends BaseService {
  // ************************************************************************
  // Public Methods
  // ************************************************************************
  /** Default Constructor */
  public StandingInstructionService(
    ...
    this.projector =
        new StandingInstructionEntityProjector(
  ...
  public void delete(DeleteStandingInstructionCommand command) {
    ...
    LOGGER.info("done deleting of StandingInstruction id:{0} ", command.getId());
  }
  ...
  public void assignBeneficiary(AssignBeneficiaryToStandingInstructionCommand command) {
    ...
    // delegate to the projector
    // --------------------------------------
    projector.assignBeneficiary(command.getParentId(), command.getChildId());
  }
  ...
  public void unAssignBeneficiary(UnAssignBeneficiaryFromStandingInstructionCommand command) {
    ...
    // delegate to the projector
    // --------------------------------------
    projector.unAssignBeneficiary(command.getParentId());
  }

  // ************************************************************************
  // Attributes
  // ************************************************************************
  @Autowired private final StandingInstructionEntityProjector projector;
