...
public class RiskAssessmentService extends BaseService {
  ...
  // ************************************************************************
  /** Default Constructor */
  public RiskAssessmentService(CurrentIdentity identity, ApplicationContext applicationContext) {

    this.identity = identity;
    this.projector =
        new RiskAssessmentEntityProjector(
  ...
  public void delete(DeleteRiskAssessmentCommand command) {
    ...
    LOGGER.info("done deleting of RiskAssessment id:{0} ", command.getId());
  }
  ...
  // Attributes
  // ************************************************************************
  @Autowired private final RiskAssessmentEntityProjector projector;
