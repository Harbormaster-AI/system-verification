...
public class BankRestController extends BaseSpringRestController {
	...
	public void addToBranches( @RequestBody(required=true) AssignBranchesToBankCommand command ) {
		...
		LOGGER.info( "Successfully added Branches with parentId:" + command.getParentId() + ", childIds:" + command.getChildIds()  );
	}
	...
	{		
		...
		LOGGER.info( "Successfully removed Branches with parentId:" + command.getParentId() + ", childIds:" + command.getChildIds()  );
	}
	...
	public void addToProducts( @RequestBody(required=true) AssignProductsToBankCommand command ) {
		...
		LOGGER.info( "Successfully added Products with parentId:" + command.getParentId() + ", childIds:" + command.getChildIds()  );
	}
	...
	{		
		...
		LOGGER.info( "Successfully removed Products with parentId:" + command.getParentId() + ", childIds:" + command.getChildIds()  );
	}
	...
	public void addToCustomers( @RequestBody(required=true) AssignCustomersToBankCommand command ) {
		...
		LOGGER.info( "Successfully added Customers with parentId:" + command.getParentId() + ", childIds:" + command.getChildIds()  );
	}
	...
	{		
		...
		LOGGER.info( "Successfully removed Customers with parentId:" + command.getParentId() + ", childIds:" + command.getChildIds()  );
	}
	...
	public void addToExchangeRates( @RequestBody(required=true) AssignExchangeRatesToBankCommand command ) {
		...
		LOGGER.info( "Successfully added ExchangeRates with parentId:" + command.getParentId() + ", childIds:" + command.getChildIds()  );
	}
	...
	{		
		...
		LOGGER.info( "Successfully removed ExchangeRates with parentId:" + command.getParentId() + ", childIds:" + command.getChildIds()  );
	}
	...
	public void addToThirdPartyProviders( @RequestBody(required=true) AssignThirdPartyProvidersToBankCommand command ) {
		...
		LOGGER.info( "Successfully added ThirdPartyProviders with parentId:" + command.getParentId() + ", childIds:" + command.getChildIds()  );
	}
	...
	{		
		...
		LOGGER.info( "Successfully removed ThirdPartyProviders with parentId:" + command.getParentId() + ", childIds:" + command.getChildIds()  );
	}
