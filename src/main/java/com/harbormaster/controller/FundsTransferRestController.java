...
public class FundsTransferRestController extends BaseSpringRestController {
    ...
    public FundsTransfer get( @RequestParam(required=true) IdentifierRequest identifier ) {
    	FundsTransfer entity = service.getFundsTransfer( new FundsTransferFetchOneSummary( identifier.getId() ) );
	...
	public void assignSourceAccount( @RequestBody AssignSourceAccountToFundsTransferCommand command ) {
		...
		LOGGER.info( "Successfully assigned SourceAccount with parentId:" + command.getParentId() + ", childId:" + command.getChildId() );
	}
	...
	public void unAssignSourceAccount( @RequestBody(required=true)  UnAssignSourceAccountFromFundsTransferCommand command ) {
		...
		LOGGER.info( "Successfully unassigned SourceAccount with parentId:" + command.getParentId() + ", childId:" + command.getChildId() );
	}
	...
	public void assignDestinationAccount( @RequestBody AssignDestinationAccountToFundsTransferCommand command ) {
		...
		LOGGER.info( "Successfully assigned DestinationAccount with parentId:" + command.getParentId() + ", childId:" + command.getChildId() );
	}
	...
	public void unAssignDestinationAccount( @RequestBody(required=true)  UnAssignDestinationAccountFromFundsTransferCommand command ) {
		...
		LOGGER.info( "Successfully unassigned DestinationAccount with parentId:" + command.getParentId() + ", childId:" + command.getChildId() );
	}
	...
	public void assignExternalBeneficiary( @RequestBody AssignExternalBeneficiaryToFundsTransferCommand command ) {
		...
		LOGGER.info( "Successfully assigned ExternalBeneficiary with parentId:" + command.getParentId() + ", childId:" + command.getChildId() );
	}
	...
	public void unAssignExternalBeneficiary( @RequestBody(required=true)  UnAssignExternalBeneficiaryFromFundsTransferCommand command ) {
		...
		LOGGER.info( "Successfully unassigned ExternalBeneficiary with parentId:" + command.getParentId() + ", childId:" + command.getChildId() );
	}
	...
	public void assignInitiatedBy( @RequestBody AssignInitiatedByToFundsTransferCommand command ) {
		...
		LOGGER.info( "Successfully assigned InitiatedBy with parentId:" + command.getParentId() + ", childId:" + command.getChildId() );
	}
	...
	public void unAssignInitiatedBy( @RequestBody(required=true)  UnAssignInitiatedByFromFundsTransferCommand command ) {
		...
		LOGGER.info( "Successfully unassigned InitiatedBy with parentId:" + command.getParentId() + ", childId:" + command.getChildId() );
	}
