...
public class CustomerRestController extends BaseSpringRestController {
	...
	public void addToAccounts( @RequestBody(required=true) AssignAccountsToCustomerCommand command ) {
		...
		LOGGER.info( "Successfully added Accounts with parentId:" + command.getParentId() + ", childIds:" + command.getChildIds()  );
	}
	...
	{		
		...
		LOGGER.info( "Successfully removed Accounts with parentId:" + command.getParentId() + ", childIds:" + command.getChildIds()  );
	}
	...
	public void addToLoanAccounts( @RequestBody(required=true) AssignLoanAccountsToCustomerCommand command ) {
		...
		LOGGER.info( "Successfully added LoanAccounts with parentId:" + command.getParentId() + ", childIds:" + command.getChildIds()  );
	}
	...
	{		
		...
		LOGGER.info( "Successfully removed LoanAccounts with parentId:" + command.getParentId() + ", childIds:" + command.getChildIds()  );
	}
	...
	public void addToPaymentCards( @RequestBody(required=true) AssignPaymentCardsToCustomerCommand command ) {
		...
		LOGGER.info( "Successfully added PaymentCards with parentId:" + command.getParentId() + ", childIds:" + command.getChildIds()  );
	}
	...
	{		
		...
		LOGGER.info( "Successfully removed PaymentCards with parentId:" + command.getParentId() + ", childIds:" + command.getChildIds()  );
	}
	...
	public void addToExternalAccounts( @RequestBody(required=true) AssignExternalAccountsToCustomerCommand command ) {
		...
		LOGGER.info( "Successfully added ExternalAccounts with parentId:" + command.getParentId() + ", childIds:" + command.getChildIds()  );
	}
	...
	{		
		...
		LOGGER.info( "Successfully removed ExternalAccounts with parentId:" + command.getParentId() + ", childIds:" + command.getChildIds()  );
	}
	...
	public void addToFundsTransfers( @RequestBody(required=true) AssignFundsTransfersToCustomerCommand command ) {
		...
		LOGGER.info( "Successfully added FundsTransfers with parentId:" + command.getParentId() + ", childIds:" + command.getChildIds()  );
	}
	...
	{		
		...
		LOGGER.info( "Successfully removed FundsTransfers with parentId:" + command.getParentId() + ", childIds:" + command.getChildIds()  );
	}
	...
	public void addToDisputes( @RequestBody(required=true) AssignDisputesToCustomerCommand command ) {
		...
		LOGGER.info( "Successfully added Disputes with parentId:" + command.getParentId() + ", childIds:" + command.getChildIds()  );
	}
	...
	{		
		...
		LOGGER.info( "Successfully removed Disputes with parentId:" + command.getParentId() + ", childIds:" + command.getChildIds()  );
	}
	...
	public void addToKycProfiles( @RequestBody(required=true) AssignKycProfilesToCustomerCommand command ) {
		...
		LOGGER.info( "Successfully added KycProfiles with parentId:" + command.getParentId() + ", childIds:" + command.getChildIds()  );
	}
	...
	{		
		...
		LOGGER.info( "Successfully removed KycProfiles with parentId:" + command.getParentId() + ", childIds:" + command.getChildIds()  );
	}
	...
	public void addToConsents( @RequestBody(required=true) AssignConsentsToCustomerCommand command ) {
		...
		LOGGER.info( "Successfully added Consents with parentId:" + command.getParentId() + ", childIds:" + command.getChildIds()  );
	}
	...
	{		
		...
		LOGGER.info( "Successfully removed Consents with parentId:" + command.getParentId() + ", childIds:" + command.getChildIds()  );
	}
