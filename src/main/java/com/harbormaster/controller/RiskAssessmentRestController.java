...
public class RiskAssessmentRestController extends BaseSpringRestController {
  ...
  public void delete(@RequestBody(required = true) DeleteRiskAssessmentCommand command) {
    ...
    LOGGER.info("Successfully deleted RiskAssessment with Id " + command.getId());
  }
   ...
   */
  @GetMapping("/get")
  public RiskAssessment get(@RequestParam(required = true) IdentifierRequest identifier) {
    RiskAssessment entity =
        service.getRiskAssessment(new RiskAssessmentFetchOneSummary(identifier.getId()));

    LOGGER.info("Successfully loaded RiskAssessment with Id " + identifier.getId());
   ...
   *
   * @return List<RiskAssessment> @GetMapping("/KycProfile") public List<RiskAssessment>
   *     KycProfile(UUID parentId) { List<RiskAssessment> riskAssessmentList =
   *     load(parentId).getKycProfile; return riskAssessmentList; }
   */
  /**
  ...
  public void unAssignKycProfile(
      @RequestBody(required = true) UnAssignKycProfileFromRiskAssessmentCommand command) {
  ...
  private static final Logger LOGGER =
      LoggerFactory.getLogger(RiskAssessmentRestController.class.getName());
}
