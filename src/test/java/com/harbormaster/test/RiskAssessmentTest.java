...
public class RiskAssessmentTest {
    ...
    try {
      ...
      if (collection == null || collection.size() == 0) {
        ...
        while (iter.hasNext()) {
          ...
          assertNotNull(
              currEntity.getRiskAssessmentId(),
  ...
  protected CreateRiskAssessmentCommand generateNewCommand() {
    CreateRiskAssessmentCommand command =
        new CreateRiskAssessmentCommand(null, 0, new Date(), RiskRating.values()[0]);
  ...
  protected UpdateRiskAssessmentCommand generateUpdateCommand() {
    UpdateRiskAssessmentCommand command =
        new UpdateRiskAssessmentCommand(null, 0, new Date(), null, RiskRating.values()[0]);
