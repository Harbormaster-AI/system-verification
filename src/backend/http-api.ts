...
identityDocuments: async (
    ...
    const response = await this.http.get(
        `/KycProfile/identityDocuments/${id}/`,
        {
            params: options
        }
    );
...
kycProfile: async (
    ...
    const response = await this.http.get(
        `/IdentityDocument/kycProfile/${id}`
    );
...
add: async (
    input: BankingProduct
): Promise<BankingProduct> => {
    const response = await this.http.post(
        `/BankingProduct/create`,
        input
    );
...
loanAccounts: async (
    ...
    const response = await this.http.get(
        `/BankingProduct/loanAccounts/${id}/`,
        {
            params: options
        }
    );
...
paymentCards: async (
    ...
    const response = await this.http.get(
        `/BankingProduct/paymentCards/${id}/`,
        {
            params: options
        }
    );
...
standingInstructions: async (
    ...
    const response = await this.http.get(
        `/Account/standingInstructions/${id}/`,
        {
            params: options
        }
    );
...
assignToStandingInstructions: async (
    id: string,
    standingInstructionsIds: string[]
): Promise<Account> => {
    const response = await this.http.put(
        `/Account/standingInstructions/${id}/`,
        {
...
externalCounterparty: async (
    ...
    const response = await this.http.get(
        `/Transaction/externalCounterparty/${id}`
    );

    return response.data;
},

addExternalCounterparty: async (
    id: string,
    input: ExternalAccountInput
): Promise<Transaction> => {
    const response = await this.http.post(
...
assignToExternalCounterparty: async (
    id: string,
...
fundsTransfer: async (
    id: string
): Promise<FundsTransfer | null> => {
    const response = await this.http.get(
        `/Transaction/fundsTransfer/${id}`
    );
...
fxTrade: async (
    id: string
): Promise<FXTrade | null> => {
    const response = await this.http.get(
        `/Transaction/fxTrade/${id}`
    );
...
transactions: async (
    ...
    const response = await this.http.get(
        `/ExternalAccount/transactions/${id}/`,
        {
            params: options
        }
    );
...
sourceAccount: async (
    ...
    const response = await this.http.get(
        `/FundsTransfer/sourceAccount/${id}`
    );

    return response.data;
},

addSourceAccount: async (
    id: string,
    input: AccountInput
): Promise<FundsTransfer> => {
    const response = await this.http.post(
...
destinationAccount: async (
    ...
    const response = await this.http.get(
        `/FundsTransfer/destinationAccount/${id}`
    );

    return response.data;
},

addDestinationAccount: async (
    id: string,
    input: AccountInput
): Promise<FundsTransfer> => {
    const response = await this.http.post(
...
assignToDestinationAccount: async (
    id: string,
...
externalBeneficiary: async (
    ...
    const response = await this.http.get(
        `/FundsTransfer/externalBeneficiary/${id}`
    );

    return response.data;
},

addExternalBeneficiary: async (
    id: string,
    input: ExternalAccountInput
): Promise<FundsTransfer> => {
    const response = await this.http.post(
...
assignToExternalBeneficiary: async (
    id: string,
...
initiatedBy: async (
    ...
    const response = await this.http.get(
        `/FundsTransfer/initiatedBy/${id}`
    );

    return response.data;
},

addInitiatedBy: async (
    id: string,
    input: CustomerInput
): Promise<FundsTransfer> => {
    const response = await this.http.post(
...
account: async (
    ...
    const response = await this.http.get(
        `/StandingInstruction/account/${id}`
    );
...
beneficiary: async (
    ...
    const response = await this.http.get(
        `/StandingInstruction/beneficiary/${id}`
    );
...
repaymentSchedule: async (
    ...
    const response = await this.http.get(
        `/LoanAccount/repaymentSchedule/${id}/`,
        {
            params: options
        }
    );
...
loanAccount: async (
    ...
    const response = await this.http.get(
        `/RepaymentSchedule/loanAccount/${id}`
    );
...
assignToThirdPartyProvider: async (
    id: string,
...
consents: async (
    ...
    const response = await this.http.get(
        `/ThirdPartyProvider/consents/${id}/`,
        {
            params: options
        }
    );
